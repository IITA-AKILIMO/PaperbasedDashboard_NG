...
ui <- bootstrapPage(
             ...
             navbarPage(windowTitle ="Nigeria",
                        title = div(img(src = "https://akilimo.sirv.com/images/ng.png","Nigeria", height = "60", style="margin-top: -14px;
                                padding-right:10px;
                               padding-bottom:10px")),
             ...
             tabPanel("Expected yield for different planting and harvest schedules",id = "spt",
                      ...
                      sidebarLayout(
                        sidebarPanel(width = 3,
                                     ...
                                     pickerInput("lga_GroupsSP", "Select state",
